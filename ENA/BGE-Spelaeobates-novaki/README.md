...
#### XML
* I created [icSpeNova-HiFi.tsv](./data/icSpeNova-HiFi.tsv)
* Run script:
    ```
    ../../../../ERGA-submission/get_submission_xmls/get_ENA_xml_files.py -f icSpeNova-HiFi.tsv -p ERGA-BGE -o icSpeNova-HiFi
    ```
...
* Submit both projects and experiment in one go, i.e:
    ```
    curl -u username:password -F "SUBMISSION=@submission.xml" -F "PROJECT=@icSpeNova-HiFi.study.xml" -F "EXPERIMENT=@icSpeNova-HiFi.exp.xml" -F "RUN=@icSpeNova-HiFi.runs.xml" "https://www.ebi.ac.uk/ena/submit/drop-box/submit/"
    ```
* Receipt:
    ```
